...
#import "PostViewGoogleController.h"
#import "CGlobal.h"
//#import "SWRevealViewController.h"
#import "MHCustomTabBarController.h"
#import "NSString+Common.h"
#import "CellSubCategory.h"
@interface PostViewGoogleController ()
@property (nonatomic,assign) CGFloat geometry_cellwidth;
@end

@implementation PostViewGoogleController
...
-(void)initData{
    EftGooglePlace*place =  [g_places objectAtIndex:g_selectedReview];
    
    _lbl_title.text = place.name;
    _lbl_rating.text = @"";
    _lbl_ratingright.text = @"";
    
    _lbl_place.text = place.name;
    _lbl_itemcategory.text = @"";
    _hcss_star.minimumValue = 0;
    _hcss_star.maximumValue = 5.0;
    _hcss_star.value = 4.2;
    ...
    _lbl_address.text = place.formatted_address;
    _lbl_phone.text = place.formatted_phone_number;
    
    if (![place.googlePicture isBlank]) {
        _img_content.imageURL = [NSURL URLWithString:place.googlePicture];
    }
